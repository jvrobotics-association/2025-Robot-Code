...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.24427).withKV(0.732);
  ...
  public static final CANBus kCANBus = new CANBus("swervebus", "./logs/swervebus.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(DriveConstants.MAX_SPEED);
  ...
  private static final Distance kWheelRadius = Inches.of(1.858);
