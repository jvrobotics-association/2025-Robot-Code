...
public class AlignProcessorCommand extends Command {
  ...
  public void initialize() {
    targetPose = FieldConstants.getNearestProcessor(m_drive.getPose());
    Logger.recordOutput("Tags/Chosen Processor", targetPose);
