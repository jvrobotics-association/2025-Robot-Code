...
public class AlignCenterReefCommand extends Command {
  ...
  public void initialize() {
    targetPose = FieldConstants.getNearestReefFace(m_drive.getPose());
    Logger.recordOutput("Tags/Chosen Reef Face", targetPose);
